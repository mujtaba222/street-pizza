...
//         ansParent.innerHTML += `<div class="col-md-6">
//         <button class="btn btn-danger w-100 rounded-pill my-2">option 1</button>
//     </div>`
//     }
// }
// showQuestion();
...
function showQuestion() {
    ...
    for (var i = 0; i<questions[indexNum].options.length; i++) {
        ansParent.innerHTML += `<div class="col-md-6">
        <button class="btn btn-danger rounded-pill w-100 my-2" onclick="checkAns('${questions[indexNum].options[i]}','${questions[indexNum].answer}')">${questions[indexNum].options[i]}</button>
    </div>`
    }
}
showQuestion();
